...
"""Unit tests for DeepSeekChatModel response parsing.

Formatter tests have been moved to tests/formatter_deepseek_test.py.
"""
...
class TestDeepSeekModelParsing(IsolatedAsyncioTestCase):
    """Unit tests for DeepSeekChatModel response parsing."""
    ...
    def _mock_completion(
        ...
        """Build a mock DeepSeek API completion response object."""
        msg = MagicMock()
        msg.content = text
